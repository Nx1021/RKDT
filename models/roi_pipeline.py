...
class CropLayer(nn.Module):
    def __init__(self, fd:"FeatureMapDistribution", max_token_num = 784, pool_size = (24, 24)) -> None:
        super().__init__()
    ...
    def use_variable_tokennum(self):
        return self.fd.use_variable_tokennum
...
class FeatureMapDistribution(nn.Module):
    def __init__(self, cfg_file) -> None:
        ...
        self.crop_layer = CropLayer(self, max_token_num, pool_size)
