...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed):
        ...
        mask = mask.flatten(1) if mask is not None else mask
    ...
    def __init__(self, cfg, aux_loss=False):
        ...
        Parameters:
            ...
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         LandmarkBranch can detect in a single image. For COCO, we recommend 100 queries.
        ...
        self.input_proj = nn.Conv2d(input_d, hidden_dim, kernel_size=1, device="cuda") ###TODO###
