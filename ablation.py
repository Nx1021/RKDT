...
if __name__ == "__main__":
    # calc_median()
    # ablation_vote_threshold(mode = 'v')
    ablation_depth()
    # # # region - 分析结果 #
    
    # results = {}
    # for directory in ["20240505183258Windows", 
    #                   "20240505190231Windows",
    #                   "20240505201306Windows",
    #                   "20240505233126Windows",
    #                   "20240506001411Windows",
    #                   "20240506010244Windows",
    #                   "20240506014109Windows",
    #                   "20240506022246Windows",
    #                   "20240506025748Windows",
    #                   "20240506032930Windows",
    #                   "20240506051809Windows",
    #                   "20240506061208Windows",
    #                   "20240506065305Windows",
    #                   "20240506073357Windows",
    #                   "20240506083031Windows"]:
    #     class_id, vote_thresholds, total_nums, reproj_nums, add_nums = _parse_vote_threshold_result(os.path.join(r"E:\shared\code\OLDT\logs\OLDTPredictor_logs", directory))
    #     total_num = max(total_nums)
    #     results[class_id] = {
    #         "vote_thresholds": vote_thresholds,
    #         "reproj": [x/total_num for x in reproj_nums],
    #         "add_nums": [x/total_num for x in add_nums]
    #     }
    ...
    #     if k == 2 or k == 6:
    #         continue
    #     vote_thresholds = v["vote_thresholds"]
    #     reproj = v["reproj"]
    #     add_nums = v["add_nums"]
    #     all_reproj.append(reproj)
    #     all_adds.append(add_nums)
    # all_reproj = np.array(all_reproj)
    # all_adds = np.array(all_adds)
    # avg_reproj = np.mean(all_reproj, axis=0)
    # avg_adds = np.mean(all_adds, axis=0)
    # print("average reproj:", avg_reproj)
    # print("average adds:", avg_adds)

    # # allreproj 保存为csv
    # df = pd.DataFrame(all_reproj)
    # df.to_csv(f"{LOGS_DIR}/all_reproj.csv")
    # df = pd.DataFrame(all_adds)
    # df.to_csv(f"{LOGS_DIR}/all_adds.csv")

    
    # # 保存结果
    # JsonIO.dump_json(f"{LOGS_DIR}/vote_threshold_result.json", results)
    # # endregion # 
