...
# %%
new_mix = VocFormat_6dPosture(f"{DATASETS_DIR}/linemod_mix_new", lazy = True)
...
#         for i in range(54819, 56819):
#             spliter.remove_elem_idx(i)

# new_mix.build_partly(list(range(54819, 56819)))

# with new_mix.get_writer().allow_overwriting():
#     for i in tqdm(range(54819, 56819)):
#         new_mix.remove(i)
